...
pdgpath='/home/m962g264/ondemand/research_repo/data-preprocess/ND_MC_Nominal_Files_FHC_mominkhan/'
idx=0
...
# **Split Datasets by Interaction Type**

# In[ ]:


test_cvnmap_qe_xz,test_cvnmap_qe_yz,test_cvnmap_res_xz,test_cvnmap_res_yz,test_cvnmap_dis_xz,test_cvnmap_dis_yz,test_cvnmap_coh_xz,test_cvnmap_coh_yz,test_cvnmap_mec_xz,test_cvnmap_mec_yz=([] for i in range(10))
qe_true_vtxy,res_true_vtxy,dis_true_vtxy,coh_true_vtxy,mec_true_vtxy,qe_reco_vtxy,res_reco_vtxy,dis_reco_vtxy,coh_reco_vtxy,mec_reco_vtxy=([] for i in range(10))
x=idx=0
...
while idx < (len(test_mode)):
    ...
    if test_mode[idx] == 0.0: # quasi-elastic
        ...
        coh_true_vtxy.append(testtruevtxy[idx])
        coh_reco_vtxy.append(testrecovtxy[idx])
        ...
        mec_true_vtxy.append(testtruevtxy[idx])
        mec_reco_vtxy.append(testrecovtxy[idx])
    idx+=1
print('\nJob complete.')
...
qe_reco_vtxy,res_reco_vtxy,dis_reco_vtxy,coh_reco_vtxy,mec_reco_vtxy=([] for i in range(5))
qe_reco_true_vtxy,res_reco_true_vtxy,dis_reco_true_vtxy,coh_reco_true_vtxy,mec_reco_true_vtxy=([] for i in range(3))
x=idx=0
...
while idx < (len(train_mode)):
    ...
    elif train_mode[idx] == 3.0: #Coh
        coh_reco_vtxy.append(recovtxy[idx])
        coh_reco_true_vtxy.append(truevtxy[idx])
    elif train_mode[idx] == 10.0: #Mec
        mec_reco_vtxy.append(recovtxy[idx])
        mec_reco_true_vtxy.append(truevtxy[idx])
    idx+=1
print('\nJob complete.')
...
test_cvnmap_coh_xz=np.array(test_cvnmap_coh_xz)
test_cvnmap_coh_yz=np.array(test_cvnmap_coh_yz)


# In[ ]:


test_cvnmap_mec_xz=np.array(test_cvnmap_mec_xz)
test_cvnmap_mec_yz=np.array(test_cvnmap_mec_yz)
...
model_regCNN.save('y_model.h5')

# Save as .pb file
tf.saved_model.save(model_regCNN, 'y_model.pb')
