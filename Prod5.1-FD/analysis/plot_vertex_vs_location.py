...
# 
#  $ PY37 plot_vertex_vs_location.py --pred_file <path/to/CSV/predictions/file> --verbose false
# 
...
for i in range(0, len(mode_names)):
    ...
    plt.text(550, 1000, '{} {} {} \n {} Vertex\n Validation'.format(DETECTOR, HORN, FLUX, COORDINATE), fontsize=12)
    ...
    for ext in ['pdf', 'png']:
        fig_reco_true.savefig(
            OUTDIR + '/' + VTX_LOCATION + '/{}_{}_{}_EA_and_Model_vs_true_vtx_{}.{}.'.format(
